      ...
      <v-card>
        <v-container>
          <v-form @submit.prevent="addEvent">
            ...
            <v-text-field v-model="start" type="date" label="Start datum (verplicht)"></v-text-field>

            <v-text-field v-model="end" type="date" label="Eind datum (verplicht)"></v-text-field>
